...
- [`tetsy-multistream-select` CHANGELOG](misc/multistream-select/CHANGELOG.md)
...
- Modified tetsy-libp2p-floodsub to no longer hash the topic. The new behaviour is now compatible with go-tetsy-libp2p and js-libp2p, but is a breaking change with regards to rust-libp2p.
