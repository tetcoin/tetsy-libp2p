...
- Make `PeerId` be `Copy`, including small `PeerId` API changes.
  [PR 1874](https://github.com/tetcoin/tet-libp2p/pull/1874/).

# 0.25.2 [2020-12-02]

- Require `tet-multistream-select-0.9.1`.
...
- The `NetworkConfig` API is now a builder that moves `self`.
  [PR 1848](https://github.com/tetcoin/tet-libp2p/pull/1848/).
...
- Rework transport boxing and move timeout configuration
  ...
  [PR 1794](https://github.com/tetcoin/tet-libp2p/pull/1794).

- Update dependencies.

# 0.22.1 [2020-09-10]

- Require at least tet-multiaddr v0.9.2 in order to fulfill `Ord` bound on
  `Multiaddr`. [PR 1742](https://github.com/tetcoin/tet-libp2p/pull/1742).
...
- Simplify incoming connection handling. The `IncomingConnectionEvent`
  ...
  [PR 1732](https://github.com/tetcoin/tet-libp2p/pull/1732).

- Allow any closure to be passed as an executor.
  [PR 1686](https://github.com/tetcoin/tet-libp2p/pull/1686)
...
- Remove `PeerId` compatibility mode for "identity" and SHA2 hashes.
  ...
  have the same hash digest. [PR 1608](https://github.com/tetcoin/tet-libp2p/pull/1608).

- Return dialer address instead of listener address as `remote_addr` in
  `MemoryTransport` `Listener` `ListenerEvent::Upgrade`
  [PR 1724](https://github.com/tetcoin/tet-libp2p/pull/1724).

# 0.21.0 [2020-08-18]

- Remove duplicates when performing address translation
  [PR 1697](https://github.com/tetcoin/tet-libp2p/pull/1697).

- Add `transport::Builder::multiplex_ext` for further customisation during
`StreamMuxer` creation. [PR 1691](https://github.com/tetcoin/tet-libp2p/pull/1691).
...
- Refactoring of connection close and disconnect behaviour.  In particular, the former
  ...
  See [PR 1619](https://github.com/tetcoin/tet-libp2p/pull/1619) for further details.
...
- Add PartialOrd and Ord for PeerId
  ([PR 1594](https://github.com/tetcoin/tet-libp2p/pull/1594)).

- Updated dependencies.

- Deprecate `StreamMuxer::is_remote_acknowledged`
  ([PR 1616](https://github.com/tetcoin/tet-libp2p/pull/1616)).
