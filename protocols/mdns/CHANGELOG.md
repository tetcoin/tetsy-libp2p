...
- Create multiple multicast response packets as required to avoid
  ...
  [PR 1877](https://github.com/tetcoin/tetsy-libp2p/pull/1877).

- Detect interface changes and join the MDNS multicast
  group on all interfaces as they become available.
  [PR 1830](https://github.com/tetcoin/tetsy-libp2p/pull/1830).
...
- Double receive buffer to 4KiB. [PR 1779](https://github.com/tetcoin/tetsy-libp2p/pull/1779/files).
...
- Allow tetsy-libp2p-mdns to use either async-std or tokio to drive required UDP
  socket ([PR 1699](https://github.com/tetcoin/tetsy-libp2p/pull/1699)).
