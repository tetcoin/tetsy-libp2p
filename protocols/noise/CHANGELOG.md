...
payloads by default. See [issue 1631](https://github.com/tetcoin/tet-libp2p/issues/1631).
...
version of `tet-libp2p-noise` altogether in these projects.
...
See [issue 1631](https://github.com/tetcoin/tet-libp2p/issues/1631).
...
- Re-add noise upgrades for IK and IX
  ([PR 1580](https://github.com/tetcoin/tet-libp2p/pull/1580)).
